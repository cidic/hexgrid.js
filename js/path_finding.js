...
function path(start_x, start_y, end_x, end_y) {
	...
	var openlist_g = MultiDimensionalArray(grid.mapsize_x+1,grid.mapsize_y+1);
	var openlist_f = MultiDimensionalArray(grid.mapsize_x+1,grid.mapsize_y+1);
	var openlist_h = MultiDimensionalArray(grid.mapsize_x+1,grid.mapsize_y+1);
